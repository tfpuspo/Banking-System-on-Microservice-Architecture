...
A banking system built on GraphQL, gRPC, Kafka, and Kong API Gateway — microservices with one isolated Postgres database each, safe money transfers via a Kafka Saga/Outbox flow, and independent identity verification at every service for stronger security.
